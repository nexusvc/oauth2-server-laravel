...
namespace Nexusvc\OAuth2Server\Storage;
...
class FluentSession extends AbstractFluentAdapter implements SessionInterface
{
     ...
     *
     * @return array Array of \Nexusvc\OAuth2\Server\Entity\ScopeEntity
     */
     ...
     * @param \Nexusvc\OAuth2\Server\Entity\ScopeEntity $scope The scopes ID might be an integer or string
     *
     * @return void
     */
