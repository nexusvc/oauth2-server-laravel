...
namespace Nexusvc\OAuth2Server;

use Nexusvc\OAuth2\Server\AuthorizationServer as Issuer;
use Nexusvc\OAuth2\Server\Exception\AccessDeniedException;
use Nexusvc\OAuth2\Server\ResourceServer as Checker;
use Nexusvc\OAuth2\Server\TokenType\TokenTypeInterface;
use Nexusvc\OAuth2\Server\Util\RedirectUri;
use Nexusvc\OAuth2Server\Exceptions\NoActiveAccessTokenException;
...
class Authorizer
{
     ...
     *
     * @var \Nexusvc\OAuth2\Server\ResourceServer
     */
    protected $checker;
     ...
     *
     * @param \Nexusvc\OAuth2\Server\AuthorizationServer $issuer
     * @param \Nexusvc\OAuth2\Server\ResourceServer $checker
     */
     ...
     * Get the issuer.
     *
     * @return \Nexusvc\OAuth2\Server\AuthorizationServer
     */
     ...
     * Get the checker.
     *
     * @return \Nexusvc\OAuth2\Server\ResourceServer
     */
     ...
     *
     * @throws \Nexusvc\OAuth2Server\Exceptions\NoActiveAccessTokenException
     *
     ...
     *
     * @param \Nexusvc\OAuth2\Server\TokenType\TokenTypeInterface $tokenType
     */
